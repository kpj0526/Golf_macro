...
internal class balios : club
{
	private IWebElement target;

	private const string loginUrl = "https://www.baliosgc.com/login/login.asp";

	private const string bookUrl = "https://www.midasgolf.co.kr/Reservation/ReservCalendar";

	public balios(int pManagerId)
	{
	...
	public override bool login(Form1 _frm)
	{
		...
		try
		{
			((WebDriver)drv).Navigate().GoToUrl("https://www.baliosgc.com/login/login.asp");
